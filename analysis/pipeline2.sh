...
## Peak
computeMatrix scale-regions -S $projPath/alignment/bigwig/K4me3_rep2_raw.bw \
	      -R $projPath/peakCalling/SEACR/K4me3_rep2_seacr_control.peaks.stringent.bed \
              --skipZeros -o $projPath/peakCalling/SEACR/K4me3_rep2_SEACR.mat.gz -p 4 

plotHeatmap -m $projPath/peakCalling/SEACR/K4me3_rep2_SEACR.mat.gz -out $projPath/peakCalling/SEACR/K4me3_rep2_SEACR_heatmap.png --sortUsing sum --startLabel "Peak Start" --endLabel "Peak End" --xAxisLabel "" --regionsLabel "Peaks" --samplesLabel "H3K4me3 rep2"
